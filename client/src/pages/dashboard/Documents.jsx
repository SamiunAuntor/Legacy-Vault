    ...
    return (
        <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-7 flex flex-wrap gap-3">
                {["All Documents", "Identity", "Financial", "Insurance", "Property", "Business", "Digital Assets"].map((filter, index) => (
                    <button key={filter} className={`rounded-full px-6 py-2 text-sm font-bold ${index === 0 ? "bg-emerald-700 text-white" : "bg-blue-50 text-slate-700"}`}>
                        {filter}
                    </button>
                ))}
            </div>
            ...
            <div className="mt-8 grid min-h-36 place-items-center rounded-2xl border-2 border-dashed border-slate-200 bg-blue-50/30">
